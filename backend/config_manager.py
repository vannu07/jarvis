...
class Config:
    ...
    def face_cascade_path(self) -> str:
        return self.get('FACE_CASCADE_PATH', 'backend/auth/haarcascade_frontalface_default.xml')
    ...
    def face_recognition_names(self) -> list:
        return self.get_list('FACE_RECOGNITION_NAMES', ['Unknown', 'Unknown', 'Varnit Kumar'])
    ...
    def audio_start_sound_path(self) -> str:
        return self.get('AUDIO_START_SOUND_PATH', 'frontend/assets/audio/start_sound.mp3')
